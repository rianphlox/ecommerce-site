            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="product-slider owl-carousel">
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="fashi/img/products/man-2.jpg" alt="">
                                <div class="icon">
                                    <i class="icon_heart_alt"></i>
                                </div>
                                <ul>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="fashi/img/latest-1.jpg" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="fashi/img/latest-2.jpg" alt="">
                        <div class="latest-text">
                            <div class="tag-list">
                                <div class="tag-item">
                                    <i class="fa fa-calendar-o"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        <img src="fashi/img/latest-3.jpg" alt="">
                        <div class="latest-text">
                            <div class="tag-list">
                                <div class="tag-item">
                                    <i class="fa fa-calendar-o"></i>
