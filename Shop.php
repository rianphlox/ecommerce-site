<?php 
    ...
    require 'config/component.php';
    
    $db = new DB();
    $products = $db->GetProductsFrom('stock');
    ?>
                    ...
                    <div class="product-list">
                        <div class="row">
                            ...
                            <?php while($product = $products->fetch_assoc()) :?>
                                <?php component($product['id'], $product['image_name'], $product['image_path'], $product['category'], $product['current_price'], $product['initial_price']) ;?>
                            <?php endwhile; ?>
                        </div>
                    </div>
